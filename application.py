...
def get_new_lists():
    ...
    def get_certs(seriesCD: [str]):
        ...
        for cd in seriesCD:
            ...
            # cert_xml_params ={'serviceKey' : 'Hyx11OV/Fa1Zcg9lbgYGyl7F4VzhlVsAuxNOOgoOxgChFDGN4j5I02v24FWhEfMyrpLT+78LQ/DZbZR1nE1W5g==', 'seriesCd' : cd }
        ...
        # params ={'serviceKey' : 'Hyx11OV/Fa1Zcg9lbgYGyl7F4VzhlVsAuxNOOgoOxgChFDGN4j5I02v24FWhEfMyrpLT+78LQ/DZbZR1nE1W5g==', 'grdCd' : '10', 'baseYY' : '2020', 'pageNo' : '1', 'numOfRows' : '95' }
    ...
    def get_certStats(gradeCD: [str], yearCD: [str]):
        ...
        for grcd in GRADECD:
            for yrcd in YEARCD:
                ...
                stats_xml_params ={'serviceKey' : 'Hyx11OV/Fa1Zcg9lbgYGyl7F4VzhlVsAuxNOOgoOxgChFDGN4j5I02v24FWhEfMyrpLT+78LQ/DZbZR1nE1W5g==', 'grdCd' : grcd, 'baseYY' : yrcd, 'pageNo' : '1', 'numOfRows' : '3000' }
...
def schedule():
    ...
    schedule_xml_params ={'serviceKey' : 'Hyx11OV/Fa1Zcg9lbgYGyl7F4VzhlVsAuxNOOgoOxgChFDGN4j5I02v24FWhEfMyrpLT+78LQ/DZbZR1nE1W5g==', 'jmCd' : cert_code}
